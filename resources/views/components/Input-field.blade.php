...
<div class="2xl:mt-3 relative">
    ...
    <input
        class="appearance-none border h-14 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @if (!empty(old($name)) && !$errors->has($name)) border-green-500 @else border-red-500 @endif"
