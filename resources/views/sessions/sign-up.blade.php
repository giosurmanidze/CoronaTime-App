                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="text-black flex items-center cursor-pointer">
                            <select id="language-select" onchange="window.location.href = this.value;">
                                <option value="{{ route('register',['language' => 'en']) }}" @if(app()->getLocale() == 'en') selected @endif>English</option>
                                <option value="{{ route('register', ['language' => 'ka']) }}" @if(app()->getLocale() == 'ka') selected @endif>Georgian</option>
                            </select>
                        </div>
                    </div>
