                ...
                <form method="POST" action="/register" class="w-full max-w-md px-4 md:ml-10 flex flex-col md:gap-2 gap-4">
                    ...
                    <div class="mt-3 flex justify-between">
                        <div class="flex gap-2">
                            <input class="form-check-input w-[15px]" type="checkbox" name="remember_device" id="remember_device">
                           <p class="text-sm text-[#010414] font-bold">{{ __('remember') }}</p> 
                        </div>
                        <a class="text-sm w-full text-[#2029F3] font-bold flex justify-end" href="#">{{__("forgot_password") }}</a>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="text-center mt-2">
                        {{ __('dont_have') }} <strong><a href="/login"
